...
export default function PrivacyPolicy() {
  return (
    <div className={cn(twp().wrapper, "mt-10 mb-20")}>
      <p>
      TERMS OF SERVICE Last updated May 08, 2024 AGREEMENT TO OUR LEGAL TERMS We
      are JAGCOMTECH LLC (&apos;Company,&apos; &apos;we,&apos; &apos;us,&apos; &apos;our&apos;), a company registered
      in Washington, United States at 3806 196TH PL SE, Bothell, WA 98012. We
      operate the mobile application PodiumAI (the &apos;App&apos;), as well as any other
      related products and services that refer or link to these legal terms
      (the &apos;Legal Terms&apos;) (collectively, the &apos;Services&apos;). PodiumAI is a mobile
      app that automatically generates customized quizzes, flashcards and study
      guides from teachers&apos; lecture transcripts. Teachers simply transcribe
      their lectures, and our AI technology does the rest - rapidly creating
      tailored materials that identify individual students&apos; knowledge gaps
      before exams. It provides students with an efficient way to reinforce
      lessons and pinpoint areas they need to spend more time on. For teachers,
      it offers a data-driven approach to refine their instruction methods based
      on student performance analytics. Important: PodiumAI doesn&apos;t record
      teacher lectures, it only performs speech to text. You can contact us
      by phone at 425-375-6459, email at dhanush.eashwar@gmail.com, or by mail
      to 3806 196TH PL SE, Bothell, WA 98012, United States. These Legal Terms
      constitute a legally binding agreement made between you, whether
      personally or on behalf of an entity (&apos;you&apos;), and JAGCOMTECH LLC,
      ...
      MUST DISCONTINUE USE IMMEDIATELY. We will provide you with prior notice of
      any scheduled changes to the Services you are using. The modified Legal
      Terms will become effective upon posting or notifying you
      by dhanush.eashwar@gmail.com, as stated in the email message. By
      continuing to use the Services after the effective date of any changes,
      you agree to be bound by the modified terms. The Services are intended for
      ...
      your records. TABLE OF CONTENTS 1. OUR SERVICES 2. INTELLECTUAL PROPERTY
      RIGHTS 3. USER REPRESENTATIONS 4. USER REGISTRATION 5. PURCHASES AND
      PAYMENT 6. PROHIBITED ACTIVITIES 7. USER GENERATED CONTRIBUTIONS 8.
      CONTRIBUTION LICENSE 9. MOBILE APPLICATION LICENSE 10. SERVICES MANAGEMENT
      11. PRIVACY POLICY 12. TERM AND TERMINATION 13. MODIFICATIONS AND
      INTERRUPTIONS 14. GOVERNING LAW 15. DISPUTE RESOLUTION 16. CORRECTIONS 17.
      DISCLAIMER 18. LIMITATIONS OF LIABILITY 19. INDEMNIFICATION 20. USER DATA
      21. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES 22. CALIFORNIA
      USERS AND RESIDENTS 23. MISCELLANEOUS 24. CONTACT US 1. OUR SERVICES The
      ...
      extent local laws are applicable. CCPA Compliance: Under the CCPA, the
      processing of personal information is based on several legal grounds,
      including: • Consent: Where applicable, JagCom seeks explicit consent from
      users for the collection and processing of their personal information.
      Users have the right to withdraw their consent at any time. • Contractual
      Necessity: Processing may occur to fulfill contractual obligations with
      users. For example, processing personal information is necessary to
      provide the requested services within the App. • Legitimate Interests:
      Some processing activities are based on JagCom&apos;s legitimate interests,
      such as enhancing the functionality of the App, improving user experience,
      and ensuring the security of user data. • Legal Obligations: Information
      may be processed to comply with legal obligations imposed on JagCom. 2.
      ...
      Terms, including the &apos;PROHIBITED ACTIVITIES&apos; section below, we grant you a
      ...
      non-commercial use. Except as set out in this section or elsewhere in our
      ...
      to: dhanush.eashwar@gmail.com. If we ever grant you the permission to
      ...
      the &apos;PROHIBITED ACTIVITIES&apos; section carefully prior to using our Services
      to understand the (a) rights you give us and (b) obligations you have when
      you post or upload any content through the Services. Submissions: By
      directly sending us any question, comment, suggestion, idea, feedback, or
      other information about the Services (&apos;Submissions&apos;), you agree to assign
      to us all intellectual property rights in such Submission. You agree that
      ...
      Services you: • confirm that you have read and agree with our &apos;PROHIBITED
      ...
      that we may suffer because of your breach of (a) this section, (b) any
      third party’s intellectual property rights, or (c) applicable law. 3. USER
      ...
      any portion thereof). 4. USER REGISTRATION You may be required to register
      to use the Services. You agree to keep your password confidential and will
      be responsible for all use of your account and password. We reserve the
      right to remove, reclaim, or change a username you select if we determine,
      in our sole discretion, that such username is inappropriate, obscene, or
      otherwise objectionable. 5. PURCHASES AND PAYMENT All purchases are
      non-refundable. We accept the following forms of payment: You agree to
      provide current, complete, and accurate purchase and account information
      for all purchases made via the Services. You further agree to promptly
      ...
      time. All payments shall be in __________. You agree to pay all charges at
      ...
      6. PROHIBITED ACTIVITIES You may not access or use the Services for any
      ...
      or otherwise transfer your profile. 7. USER GENERATED CONTRIBUTIONS The
      Services does not offer users to submit or post content. We may provide
      ...
      minors. • Your Contributions do not include any offensive comments that
      ...
      applicable law or regulation. Any use of the Services in violation of the
      ...
      8. CONTRIBUTION LICENSE You and Services agree that we may access, store,
      ...
      regarding the Services, you agree that we can use and share such feedback
      ...
      regarding your Contributions. 9. MOBILE APPLICATION LICENSE Use License If
      ...
      the App. Apple and Android Devices The following terms apply when you use
      ...
      our App is limited to a non-transferable license to use the application on
      ...
      support services with respect to the App; (3) in the event of any failure
      ...
      the App, and to the maximum extent permitted by applicable law, the App
      Distributor will have no other warranty obligation whatsoever with respect
      to the App; (4) you represent and warrant that (i) you are not located in
      ...
      third-party beneficiary thereof. 10. SERVICES MANAGEMENT We reserve the
      ...
      of the Services. 11. PRIVACY POLICY We care about data privacy and
      security. Please review our Privacy
      Policy: https://podiumai.vercel.app/privacy. By using the Services, you
      ...
      12. TERM AND TERMINATION These Legal Terms shall remain in full force and
      ...
      State of Washington applicable to agreements made and to be entirely
      performed within the State of Washington, without regard to its conflict
      of law principles. 15. DISPUTE RESOLUTION Informal Negotiations To
      ...
      the other Party. Binding Arbitration If the Parties are unable to resolve
      a Dispute through informal negotiations, the Dispute (except those
      ...
      in United States, Washington. Except as otherwise provided herein, the
      ...
      the award entered by the arbitrator. If for any reason, a Dispute proceeds
      ...
      States, Washington, and the Parties hereby consent to, and waive
      ...
      shall any Dispute brought by either Party related in any way to the
      Services be commenced more than one (1) years after the cause of action
      ...
      to utilize class action procedures; and (c) there is no right or authority
      ...
      16. CORRECTIONS There may be information on the Services that contains
      ...
      17. DISCLAIMER THE SERVICES ARE PROVIDED ON AN AS-IS AND AS-AVAILABLE
      ...
      BEST JUDGMENT AND EXERCISE CAUTION WHERE APPROPRIATE. 18. LIMITATIONS OF
      ...
      ADDITIONAL RIGHTS. 19. INDEMNIFICATION You agree to defend, indemnify, and
      ...
      use of the Services; (2) breach of these Legal Terms; (3) any breach of
      your representations and warranties set forth in these Legal Terms; (4)
      ...
      indemnification upon becoming aware of it. 20. USER DATA We will maintain
      certain data that you transmit to the Services for the purpose of managing
      the performance of the Services, as well as data relating to your use of
      ...
      or corruption of such data. 21. ELECTRONIC COMMUNICATIONS, TRANSACTIONS,
      AND SIGNATURES Visiting the Services, sending us emails, and completing
      ...
      credits by any means other than electronic means. 22. CALIFORNIA USERS AND
      RESIDENTS If any complaint with us is not satisfactorily resolved, you can
      ...
      (800) 952-5210 or (916) 445-1254. 23. MISCELLANEOUS These Legal Terms and
      any policies or operating rules posted by us on the Services or in respect
      to the Services constitute the entire agreement and understanding between
      ...
      provision. These Legal Terms operate to the fullest extent permissible by
      ...
      Terms. 24. CONTACT US In order to resolve a complaint regarding the
      Services or to receive further information regarding use of the Services,
      please contact us at: JAGCOMTECH LLC 3806 196TH PL SE Bothell, WA 98012
      United States Phone: 425-375-6459  dhanush.eashwar@gmail.com
      </p>
    </div>
  );
}
